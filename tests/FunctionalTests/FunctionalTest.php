...
//        return $this;
    ...
    public function assertResponseOk()
    {
        ...
        $this->assertTrue($this->response->isOk(), "Expected status code 200, got {$actual}.");
    ...
    public function assertResponseStatus($code)
    {
        ...
        $this->assertTrue($code, $this->response->getStatusCode(), "Expected status code {$code}, got {$actual}.");
    ...
    {
        $this->matcher->shouldContain($this->response->getContent(), $text);
    ...
    {
        $this->matcher->shouldNotContain($this->response->getContent(), $text);
    ...
    protected function seeInElement($element, $text)
    {
        ...
        $this->matcher->shouldContain($content, $text);
